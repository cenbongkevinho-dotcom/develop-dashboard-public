# Project Dashboard (Public Mirror)

中文 | English

This repository publishes a sanitized public mirror of the project dashboard for easy mobile viewing. It contains:
- Markdown dashboard view
- HTML dashboard (render via HTMLPreview)
- JSON data source (sanitized summary only)

Quick links:
- Dashboard (Markdown): https://github.com/cenbongkevinho-dotcom/develop-dashboard-public/blob/main/docs/project-dashboard.md
...
该仓库是项目仪表盘的精简公开镜像，方便手机访问。包含：
- Markdown 仪表盘视图
- HTML 仪表盘（通过 HTMLPreview 自动渲染）
- JSON 数据源（仅含脱敏汇总）
